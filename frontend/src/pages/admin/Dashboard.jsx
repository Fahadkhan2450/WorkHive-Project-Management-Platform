  ...
  return (
    <DashboardLayout activeMenu={"Dashboard"}>
      <div className="p-6 space-y-6">
        {/* Welcome Card */}
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-6 shadow-lg text-white flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
          ...
          {currentUser?.role === "admin" && (
            <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
              ...
              <button
                className="bg-white text-green-600 hover:bg-green-50 px-6 py-2 rounded-lg font-medium transition-all duration-200 shadow-md"
        ...
        {/* Recent Tasks */}
        {dashboardData?.recentTasks && <RecentTasks tasks={dashboardData.recentTasks} />}
      </div>
    </DashboardLayout>
  );
};
